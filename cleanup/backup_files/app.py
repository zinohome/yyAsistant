...
app.layout = lambda: fuc.FefferyTopProgress(
    [
        ...
        *(
        ...
        # 新的状态管理器
        # html.Script(src="/assets/js/state_manager.js"),  # 暂时禁用，避免冲突
        # 新的状态管理器V2
        # html.Script(src="/assets/js/state_manager_v2.js"),  # 暂时禁用，避免冲突
        # 新的WebSocket管理器V2
        # html.Script(src="/assets/js/websocket_manager_v2.js"),  # 暂时禁用，避免与voice_websocket_manager.js冲突
        # 统一按钮状态管理器脚本（保持兼容性）
